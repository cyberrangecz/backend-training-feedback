package cz.cyberrange.platform.training.feedback.handler;

import cz.cyberrange.platform.training.feedback.exceptions.BadRequestException;
import cz.cyberrange.platform.training.feedback.exceptions.EntityConflictException;
import cz.cyberrange.platform.training.feedback.exceptions.EntityNotFoundException;
import cz.cyberrange.platform.training.feedback.exceptions.ForbiddenException;
import cz.cyberrange.platform.training.feedback.exceptions.InternalServerErrorException;
import cz.cyberrange.platform.training.feedback.exceptions.MicroserviceApiException;
import cz.cyberrange.platform.training.feedback.exceptions.TooManyRequestsException;
import cz.cyberrange.platform.training.feedback.exceptions.UnprocessableEntityException;
import cz.cyberrange.platform.training.feedback.exceptions.errors.ApiEntityError;
import cz.cyberrange.platform.training.feedback.exceptions.errors.ApiError;
import cz.cyberrange.platform.training.feedback.exceptions.errors.ApiMicroserviceError;
